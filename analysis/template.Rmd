...
![](../docs/assets/logo.png){width="10%"}

#### Way 2

```{r out.width="10%", fig.cap="Figure: Logo.",fig.align='center', echo=TRUE}
knitr::include_graphics(c("../docs/assets/logo.png"), error = FALSE)
```
...
Link to [another header](2025.html#header-of-another-section) by `[another header](2025.html#header-of-another-section)`.
